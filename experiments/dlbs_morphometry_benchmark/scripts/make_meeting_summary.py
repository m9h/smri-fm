...
DISPLAY = {
    ...
    "ridge_t1prep_thickness_icv": ("T1Prep thickness + ICV",      "morph",  71),
    "ridge_t1prep_area":          ("T1Prep area (DKT)",           "morph",  71),
    "ridge_t1prep_area_icv":      ("T1Prep area + ICV",           "morph",  71),
    "ridge_t1prep_thkarea":       ("T1Prep thk+area concat",      "morph", 142),
    "ridge_t1prep_tissue_icv":    ("T1Prep tissue ratios + ICV",  "morph",   4),
