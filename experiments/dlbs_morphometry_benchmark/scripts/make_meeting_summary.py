...
DISPLAY = {
    ...
    "ridge_concat_fs_t1prep_brainiac_pca8":("FS+T1Prep+BrainIAC + PCA-8", "concat",  8),
    "ridge_concat_fs_t1prep_brainiac_pca16":("FS+T1Prep+BrainIAC + PCA-16","concat",16),
    "ridge_concat_fs_t1prep_brainiac_pca32":("FS+T1Prep+BrainIAC + PCA-32","concat",32),
    "ridge_concat_fs_t1prep_brainiac_pca48":("FS+T1Prep+BrainIAC + PCA-48","concat",48),
    "ridge_concat_fs_TIV_t1prep_thk":          ("FS(TIV) + T1Prep concat",                "concat", 171),
    "ridge_concat_synthseg_TIV_t1prep_thk":    ("SynthSeg(TIV) + T1Prep concat",          "concat", 143),
    "ridge_concat_fs_TIV_t1prep_brainiac":     ("FS(TIV) + T1Prep + BrainIAC",            "concat", 939),
    "ridge_concat_fs_TIV_t1prep_brainiac_pca48":("FS(TIV) + T1Prep + BrainIAC + PCA-48",  "concat",  48),
