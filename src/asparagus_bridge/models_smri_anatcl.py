...
class SmriAnatclUniformSegBackbone(UniformSegBackbone):
    """AnatCL ResNet-18 encoder + shared uniform decoder."""
    ...
    def _pyramid(self, x):
        e = self.encoder
        s0 = e.relu(e.bn1(e.conv1(x))); s1 = e.layer1(e.maxpool(s0))
